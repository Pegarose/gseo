...
- **路径**: `.prismx/skills/system-designer/references/system-design-template.md`
- **用途**: L0 导航层模板，14章节结构，操作契约表格格式
- **使用**: `view_file .prismx/skills/system-designer/references/system-design-template.md`

### 工具2: 系统设计 L1 模板（实现层）

- **路径**: `.prismx/skills/system-designer/references/system-design-detail-template.md`
- **用途**: L1 实现层模板，触发 R1-R5 任意一条时创建 `{system}.detail.md`
- **使用**: `view_file .prismx/skills/system-designer/references/system-design-detail-template.md`

### 工具3: 调研报告存储

- **路径**: `.prismx/arch/v{N}/SYSTEM_DESIGN/_research/{system-id}-research.md`
- **用途**: 保存 /explore 的调研结果
...
```
使用模板填充14章节 → 保存到:
.prismx/arch/v{N}/SYSTEM_DESIGN/backend-api-system.md
```
