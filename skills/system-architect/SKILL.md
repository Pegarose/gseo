...
使用以下结构产出 `.prismx/arch/v{N}/ARCHITECTURE.md`：
...
**设计文档**: `SYSTEM_DESIGN/frontend-system.md` (待创建)
...
**设计文档**: `SYSTEM_DESIGN/backend-api-system.md` (待创建)
...
**设计文档**: `SYSTEM_DESIGN/database-system.md` (待创建)
...
使用模板填充内容 → 保存到 `.prismx/arch/v{N}/ARCHITECTURE.md`
