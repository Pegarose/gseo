...
export class TechnicalModule implements ScoreModule {
  ...
  async run(context: ScoreContext): Promise<ScoreModuleResult> {
    ...
    const { title, metaDescription: description, headings, jsonLd } = context.parsed;
    const og: any = {}; // TODO: phase 2 properly extract OG
    const twitter: any = {}; // TODO: phase 2 properly extract twitter
